...
description: "REST API for school administration: sessions, terms, wings, campuses, departments, class levels, and grading scales. Requires admin-level access."
---
...
<ParamField body="education_tier" type="string">
