---
title: "Finance API — Fees, Payments, Scholarships, and Marketplace"
sidebarTitle: "Finance"
description: "REST endpoints for school finance: fee type definitions, per-class fee structures, student payment records, scholarship funds and recipients, and the school marketplace."
---
...
<ResponseField name="id" type="string (UUID)">
  Unique identifier of the scholarship fund.
</ResponseField>
<ResponseField name="name" type="string">
...
<ResponseField name="request_items" type="array">
  ...
  <Expandable title="RequestItem fields">
    <ResponseField name="id" type="string (UUID)">Unique identifier of the line item.</ResponseField>
...
<ResponseField name="id" type="string (UUID)">
  Unique identifier of the restock event.
</ResponseField>
<ResponseField name="item" type="integer (FK)">
